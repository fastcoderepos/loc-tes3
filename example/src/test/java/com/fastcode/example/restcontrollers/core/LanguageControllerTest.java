...
public class LanguageControllerTest {
	...
	public void setup() {
		...
		final LanguageController languageController = new LanguageController(languageAppService, filmAppService,
	logHelper,env);
		when(logHelper.getLogger()).thenReturn(loggerMock);
		doNothing().when(loggerMock).error(anyString());

		this.mvc = MockMvcBuilders.standaloneSetup(languageController)
	...
	public void FindById_IdIsValid_ReturnStatusOk() throws Exception {
		...
		mvc.perform(get("/language/" + language.getLanguageId()+"/")
	...
	public void FindById_IdIsNotValid_ReturnStatusNotFound() {
		 ...
		 org.assertj.core.api.Assertions.assertThatThrownBy(() -> mvc.perform(get("/language/999")
				.contentType(MediaType.APPLICATION_JSON))
	...
	public void CreateLanguage_LanguageDoesNotExist_ReturnStatusOk() throws Exception {
		...
		mvc.perform(post("/language").contentType(MediaType.APPLICATION_JSON).content(json))
		.andExpect(status().isOk());
	...
	public void DeleteLanguage_IdIsNotValid_ThrowEntityNotFoundException() {
        ...
        org.assertj.core.api.Assertions.assertThatThrownBy(() ->  mvc.perform(delete("/language/999")
				.contentType(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk())).hasCause(new EntityNotFoundException("There does not exist a language with a id=999"));
    ...
    //    Mockito.when(languageAppService.findById(entity.getLanguageId())).thenReturn(output);
		...
		mvc.perform(delete("/language/" + entity.getLanguageId()+"/")
				.contentType(MediaType.APPLICATION_JSON))
	...
	public void UpdateLanguage_LanguageDoesNotExist_ReturnStatusNotFound() throws Exception {
		...
		String json = ow.writeValueAsString(language);
		 ...
		 org.assertj.core.api.Assertions.assertThatThrownBy(() -> mvc.perform(put("/language/999").contentType(MediaType.APPLICATION_JSON).content(json))
					.andExpect(status().isOk())).hasCause(new EntityNotFoundException("Unable to update. Language with id=999 not found."));
	}    
	...
	public void UpdateLanguage_LanguageExists_ReturnStatusOk() throws Exception {
		...
		mvc.perform(put("/language/" + entity.getLanguageId()+"/").contentType(MediaType.APPLICATION_JSON).content(json))
		.andExpect(status().isOk());
	...
	public void FindAll_SearchIsNotNullAndPropertyIsValid_ReturnStatusOk() throws Exception {
		...
		mvc.perform(get("/language?search=languageId[equals]=1&limit=10&offset=1")
				.contentType(MediaType.APPLICATION_JSON))
		.andExpect(status().isOk());
	}    
	...
	public void FindAll_SearchIsNotNullAndPropertyIsNotValid_ThrowException() throws Exception {
		...
		org.assertj.core.api.Assertions.assertThatThrownBy(() ->  mvc.perform(get("/language?search=languagelanguageId[equals]=1&limit=10&offset=1")
				.contentType(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk())).hasCause(new Exception("Wrong URL Format: Property languagelanguageId not found!"));
	...
	public void GetFilms_searchIsNotEmptyAndPropertyIsNotValid_ThrowException() {
		...
		org.assertj.core.api.Assertions.assertThatThrownBy(() ->  mvc.perform(get("/language/1/films?search=abc[equals]=1&limit=10&offset=1")
				.contentType(MediaType.APPLICATION_JSON))
	...
	public void GetFilms_searchIsNotEmptyAndPropertyIsValid_ReturnList() throws Exception {
        ...
        Mockito.when(languageAppService.parseFilmsJoinColumn("languageId")).thenReturn(joinCol);
		mvc.perform(get("/language/1/films?search=languageId[equals]=1&limit=10&offset=1")
				.contentType(MediaType.APPLICATION_JSON))
	    		  .andExpect(status().isOk());
	}  
	...
	public void GetFilms_searchIsNotEmpty() {
	    ...
	    org.assertj.core.api.Assertions.assertThatThrownBy(() -> mvc.perform(get("/language/1/films?search=languageId[equals]=1&limit=10&offset=1")
				.contentType(MediaType.APPLICATION_JSON))
