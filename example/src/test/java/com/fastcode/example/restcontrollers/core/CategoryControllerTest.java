...
public class CategoryControllerTest {
	...
	public void setup() {
		...
		final CategoryController categoryController = new CategoryController(categoryAppService, filmCategoryAppService,
	logHelper,env);
	...
	public void FindById_IdIsValid_ReturnStatusOk() throws Exception {
		...
		mvc.perform(get("/category/" + category.getCategoryId()+"/")
	...
	public void FindById_IdIsNotValid_ReturnStatusNotFound() {
		 ...
		 org.assertj.core.api.Assertions.assertThatThrownBy(() -> mvc.perform(get("/category/999")
				.contentType(MediaType.APPLICATION_JSON))
	...
	public void CreateCategory_CategoryDoesNotExist_ReturnStatusOk() throws Exception {
		...
		mvc.perform(post("/category").contentType(MediaType.APPLICATION_JSON).content(json))
		.andExpect(status().isOk());
	...
	public void DeleteCategory_IdIsNotValid_ThrowEntityNotFoundException() {
        ...
        org.assertj.core.api.Assertions.assertThatThrownBy(() ->  mvc.perform(delete("/category/999")
				.contentType(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk())).hasCause(new EntityNotFoundException("There does not exist a category with a id=999"));
    ...
    //    Mockito.when(categoryAppService.findById(entity.getCategoryId())).thenReturn(output);
		...
		mvc.perform(delete("/category/" + entity.getCategoryId()+"/")
				.contentType(MediaType.APPLICATION_JSON))
	...
	public void UpdateCategory_CategoryDoesNotExist_ReturnStatusNotFound() throws Exception {
		...
		String json = ow.writeValueAsString(category);
		 ...
		 org.assertj.core.api.Assertions.assertThatThrownBy(() -> mvc.perform(put("/category/999").contentType(MediaType.APPLICATION_JSON).content(json))
					.andExpect(status().isOk())).hasCause(new EntityNotFoundException("Unable to update. Category with id=999 not found."));
	}    
	...
	public void UpdateCategory_CategoryExists_ReturnStatusOk() throws Exception {
		...
		mvc.perform(put("/category/" + entity.getCategoryId()+"/").contentType(MediaType.APPLICATION_JSON).content(json))
		.andExpect(status().isOk());
	...
	public void FindAll_SearchIsNotNullAndPropertyIsValid_ReturnStatusOk() throws Exception {
		...
		mvc.perform(get("/category?search=categoryId[equals]=1&limit=10&offset=1")
				.contentType(MediaType.APPLICATION_JSON))
		.andExpect(status().isOk());
	}    
	...
	public void FindAll_SearchIsNotNullAndPropertyIsNotValid_ThrowException() throws Exception {
		...
		org.assertj.core.api.Assertions.assertThatThrownBy(() ->  mvc.perform(get("/category?search=categorycategoryId[equals]=1&limit=10&offset=1")
				.contentType(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk())).hasCause(new Exception("Wrong URL Format: Property categorycategoryId not found!"));
	...
	public void GetFilmCategorys_searchIsNotEmptyAndPropertyIsNotValid_ThrowException() {
		...
		org.assertj.core.api.Assertions.assertThatThrownBy(() ->  mvc.perform(get("/category/1/filmCategorys?search=abc[equals]=1&limit=10&offset=1")
				.contentType(MediaType.APPLICATION_JSON))
	...
	public void GetFilmCategorys_searchIsNotEmptyAndPropertyIsValid_ReturnList() throws Exception {
        ...
        Mockito.when(categoryAppService.parseFilmCategorysJoinColumn("categoryId")).thenReturn(joinCol);
		mvc.perform(get("/category/1/filmCategorys?search=categoryId[equals]=1&limit=10&offset=1")
				.contentType(MediaType.APPLICATION_JSON))
	    		  .andExpect(status().isOk());
	}  
	...
	public void GetFilmCategorys_searchIsNotEmpty() {
	    ...
	    org.assertj.core.api.Assertions.assertThatThrownBy(() -> mvc.perform(get("/category/1/filmCategorys?search=categoryId[equals]=1&limit=10&offset=1")
				.contentType(MediaType.APPLICATION_JSON))
