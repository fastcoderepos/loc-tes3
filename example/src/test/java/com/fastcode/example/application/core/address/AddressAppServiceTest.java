...
import com.fastcode.example.domain.core.address.*;
...
//		search.setOperator("equals");
   ...
   //City
	...
	@Test
	public void ParsecustomUsersJoinColumn_KeysStringIsNotEmptyAndKeyValuePairDoesNotExist_ReturnNull()
	{
	    Map<String,String> joinColumnMap = new HashMap<String,String>();
		String keyString= "15";
		joinColumnMap.put("addressId", keyString);
		Assertions.assertThat(_appService.parseCustomUsersJoinColumn(keyString)).isEqualTo(joinColumnMap);
	}
	@Test
