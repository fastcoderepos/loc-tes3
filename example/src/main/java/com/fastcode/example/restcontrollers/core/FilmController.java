...
import com.fastcode.example.application.core.film.IFilmAppService;
import com.fastcode.example.application.core.film.dto.*;
import com.fastcode.example.application.core.filmactor.IFilmActorAppService;
import com.fastcode.example.application.core.filmactor.dto.FindFilmActorByIdOutput;
import com.fastcode.example.application.core.filmcategory.IFilmCategoryAppService;
import com.fastcode.example.application.core.filmcategory.dto.FindFilmCategoryByIdOutput;
import com.fastcode.example.application.core.inventory.IInventoryAppService;
import com.fastcode.example.application.core.inventory.dto.FindInventoryByIdOutput;
import com.fastcode.example.application.core.language.ILanguageAppService;
import java.util.*;
import java.time.*;
...
public class FilmController {
	...
	@NonNull  protected final ILanguageAppService  _languageAppService;
	...
	public void delete(@PathVariable String id) {
    	...
    	Optional.ofNullable(output).orElseThrow(() -> new EntityNotFoundException(String.format("There does not exist a film with a id=%s", id)));
	...
	public ResponseEntity<UpdateFilmOutput> update(@PathVariable String id, @RequestBody @Valid UpdateFilmInput film) {
		...
		Optional.ofNullable(currentFilm).orElseThrow(() -> new EntityNotFoundException(String.format("Unable to update. Film with id=%s not found.", id)));
	...
	@RequestMapping(value = "/{id}/filmActors", method = RequestMethod.GET, consumes = {"application/json"}, produces = {"application/json"})
	public ResponseEntity getFilmActors(@PathVariable String id, @RequestParam(value="search", required=false) String search, @RequestParam(value = "offset", required=false) String offset, @RequestParam(value = "limit", required=false) String limit, Sort sort)throws Exception {
   		if (offset == null) { offset = env.getProperty("fastCode.offset.default"); }
		if (limit == null) { limit = env.getProperty("fastCode.limit.default"); }
	...
	@RequestMapping(value = "/{id}/filmCategorys", method = RequestMethod.GET, consumes = {"application/json"}, produces = {"application/json"})
	public ResponseEntity getFilmCategorys(@PathVariable String id, @RequestParam(value="search", required=false) String search, @RequestParam(value = "offset", required=false) String offset, @RequestParam(value = "limit", required=false) String limit, Sort sort)throws Exception {
   		if (offset == null) { offset = env.getProperty("fastCode.offset.default"); }
		if (limit == null) { limit = env.getProperty("fastCode.limit.default"); }
	...
	public ResponseEntity getInventorys(@PathVariable String id, @RequestParam(value="search", required=false) String search, @RequestParam(value = "offset", required=false) String offset, @RequestParam(value = "limit", required=false) String limit, Sort sort)throws Exception {
   		if (offset == null) { offset = env.getProperty("fastCode.offset.default"); }
		if (limit == null) { limit = env.getProperty("fastCode.limit.default"); }
	...
	@RequestMapping(value = "/{id}/language", method = RequestMethod.GET, consumes = {"application/json"}, produces = {"application/json"})
