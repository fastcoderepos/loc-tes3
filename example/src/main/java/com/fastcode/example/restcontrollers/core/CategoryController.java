...
import com.fastcode.example.application.core.category.ICategoryAppService;
...
public class CategoryController {
	...
	@NonNull protected final ICategoryAppService _categoryAppService;
	...
	public void delete(@PathVariable String id) {
    	...
    	Optional.ofNullable(output).orElseThrow(() -> new EntityNotFoundException(String.format("There does not exist a category with a id=%s", id)));
	...
	public ResponseEntity<UpdateCategoryOutput> update(@PathVariable String id, @RequestBody @Valid UpdateCategoryInput category) {

	    FindCategoryByIdOutput currentCategory = _categoryAppService.findById(Integer.valueOf(id));
		Optional.ofNullable(currentCategory).orElseThrow(() -> new EntityNotFoundException(String.format("Unable to update. Category with id=%s not found.", id)));
