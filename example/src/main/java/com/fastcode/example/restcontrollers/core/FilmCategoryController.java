...
public class FilmCategoryController {
	...
	public void delete(@PathVariable String id) {
		...
		Optional.ofNullable(filmcategoryid).orElseThrow(() -> new EntityNotFoundException(String.format("Invalid id=%s", id)));

		FindFilmCategoryByIdOutput output = _filmCategoryAppService.findById(filmcategoryid);
    	Optional.ofNullable(output).orElseThrow(() -> new EntityNotFoundException(String.format("There does not exist a filmCategory with a id=%s", id)));
	...
	public ResponseEntity<UpdateFilmCategoryOutput> update(@PathVariable String id, @RequestBody @Valid UpdateFilmCategoryInput filmCategory) {
		...
		Optional.ofNullable(currentFilmCategory).orElseThrow(() -> new EntityNotFoundException(String.format("Unable to update. FilmCategory with id=%s not found.", id)));
	...
	@RequestMapping(value = "/{id}/category", method = RequestMethod.GET, consumes = {"application/json"}, produces = {"application/json"})
