...
public class InventoryController {
	...
	public void delete(@PathVariable String id) {
    	...
    	Optional.ofNullable(output).orElseThrow(() -> new EntityNotFoundException(String.format("There does not exist a inventory with a id=%s", id)));
	...
	public ResponseEntity<UpdateInventoryOutput> update(@PathVariable String id, @RequestBody @Valid UpdateInventoryInput inventory) {
		...
		Optional.ofNullable(currentInventory).orElseThrow(() -> new EntityNotFoundException(String.format("Unable to update. Inventory with id=%s not found.", id)));
