...
import { Globals, PickerDialogService, PickerComponent, ListFiltersComponent, ConfirmDialogComponent, ToolTipRendererDirective} from 'src/app/common/shared';
...
import {
  ...
  MatChipsModule, MatSortModule, MatSnackBarModule, MatProgressSpinnerModule, MatTooltipModule
...
export var imports: any[] = [
  ...
  NgxMaterialTimepickerModule, TranslateTestingModule, MatTooltipModule
];
