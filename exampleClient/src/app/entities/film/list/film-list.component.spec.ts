...
import { IFilm, FilmService, FilmDetailsComponent, FilmListComponent,
	FilmNewComponent } from '../';
...
describe('FilmListComponent', () => {
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/film/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
