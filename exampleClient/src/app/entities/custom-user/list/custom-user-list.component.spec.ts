...
import { ICustomUser, CustomUserService, CustomUserDetailsComponent, CustomUserListComponent,
	CustomUserNewComponent } from '../';

describe('CustomUserListComponent', () => {
  ...
  let data: ICustomUser[] = [... constData];
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'customuser', component: CustomUserListComponent },
            { path: 'customuser/:id', component: CustomUserDetailsComponent }
          ])
        ],
        providers: [
          CustomUserService,
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/customuser/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
