...
import { ICustomUser, CustomUserService, CustomUserDetailsComponent, CustomUserListComponent } from '../';
...
describe('CustomUserDetailsComponent', () => {
  let component: CustomUserDetailsComponent;
  let fixture: ComponentFixture<CustomUserDetailsComponent>;
  let el: HTMLElement;
  ...
  describe('Unit Tests', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(CustomUserDetailsComponent);
  ...
  describe('Integration Tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'customuser', component: CustomUserDetailsComponent },
            { path: 'customuser/:id', component: CustomUserListComponent }
          ])
        ],
        providers: [
          CustomUserService
    ...
    it('should go back to list component when back button is clicked', async () => {
      ...
      expect(location.path()).toBe('/customuser');
