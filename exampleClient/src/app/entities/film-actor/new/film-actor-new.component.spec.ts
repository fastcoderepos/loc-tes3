...
import { IFilmActor,FilmActorService, FilmActorNewComponent } from '../';
import { DateUtils } from 'src/app/common/shared';
import { NewComponent, FieldsComp } from 'src/app/common/general-components';

describe('FilmActorNewComponent', () => {
  let component: FilmActorNewComponent;
  let fixture: ComponentFixture<FilmActorNewComponent>;
  ...
  describe('Unit tests', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(FilmActorNewComponent);
