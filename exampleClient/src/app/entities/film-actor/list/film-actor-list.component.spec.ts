...
import { IFilmActor, FilmActorService, FilmActorDetailsComponent, FilmActorListComponent,
	FilmActorNewComponent } from '../';

describe('FilmActorListComponent', () => {
  let fixture:ComponentFixture<FilmActorListComponent>;
  let component:FilmActorListComponent;
  let el: HTMLElement;
  
  let d = new Date();
  let t = DateUtils.formatDateStringToAMPM(d);
  let constData:IFilmActor[] = [
    {   
      actorId: 1,
      filmId: 1,
      lastUpdate: d,
  ...
  describe('Unit tests', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(FilmActorListComponent);
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'filmactor', component: FilmActorListComponent },
            { path: 'filmactor/:id', component: FilmActorDetailsComponent }
          ])
        ],
        providers: [
          FilmActorService,
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/filmactor/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
