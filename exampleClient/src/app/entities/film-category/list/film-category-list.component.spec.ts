...
import { IFilmCategory, FilmCategoryService, FilmCategoryDetailsComponent, FilmCategoryListComponent,
	FilmCategoryNewComponent } from '../';
...
describe('FilmCategoryListComponent', () => {
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'filmcategory', component: FilmCategoryListComponent },
            { path: 'filmcategory/:id', component: FilmCategoryDetailsComponent }
          ])
        ],
        providers: [
          FilmCategoryService,
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/filmcategory/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
