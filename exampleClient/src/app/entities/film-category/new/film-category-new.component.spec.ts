...
import { IFilmCategory,FilmCategoryService, FilmCategoryNewComponent } from '../';
import { DateUtils } from 'src/app/common/shared';
import { NewComponent, FieldsComp } from 'src/app/common/general-components';

describe('FilmCategoryNewComponent', () => {
  let component: FilmCategoryNewComponent;
  let fixture: ComponentFixture<FilmCategoryNewComponent>;
  ...
  describe('Unit tests', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(FilmCategoryNewComponent);
