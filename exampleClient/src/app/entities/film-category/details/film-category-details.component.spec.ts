...
import { IFilmCategory, FilmCategoryService, FilmCategoryDetailsComponent, FilmCategoryListComponent } from '../';
...
describe('FilmCategoryDetailsComponent', () => {
  ...
  describe('Integration Tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 'filmcategory', component: FilmCategoryDetailsComponent },
            { path: 'filmcategory/:id', component: FilmCategoryListComponent }
          ])
        ],
        providers: [
          FilmCategoryService
    ...
    it('should go back to list component when back button is clicked', async () => {
      ...
      expect(location.path()).toBe('/filmcategory');
